...
--gtf ../Data_preparation/Nab3_dataset_100nt/test_count_output_FDRs_r100_norm100_no_overlaps.gtf \
...
--neg-gtf ../Data_preparation/Nab3_dataset_100nt/test_count_output_FDRs_r100_norm100_negative_controls.gtf \
--length 100 \
--no-depfold
